...
const SHORTCUT_CATEGORIES: CategoryGroup[] = [
    ...
    },
    {
        ...
        shortcuts: [
            ...
            { id: 'tools-combat-sim', label: 'Combat Analysis', icon: <Shield size={16} />, color: '#14b8a6', glowColor: 'rgba(20, 184, 166, 0.3)', view: 'tools', tab: 'combat-sim' },
            ...
            { id: 'tools-acs-splitter', label: 'ACS Splitter', icon: <Target size={16} />, color: '#14b8a6', glowColor: 'rgba(20, 184, 166, 0.3)', view: 'tools', tab: 'acs-splitter', inTesting: true },
